...
def send_email(recipient, subject, temp=None, message="", sender="no-reply", sender_name="PANSON joieria", recipient_name=None, internal_recipient=False, cc=None, **kwargs):
